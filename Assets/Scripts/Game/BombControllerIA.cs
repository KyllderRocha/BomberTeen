...
public class BombControllerIA : MonoBehaviour
{
    /*
     * Melhorias
     * 
    ...
    */
    ...
    private IEnumerator PlaceBomb()
    {
        ...
        explosion.SetActiveAnimatedRenderer(explosion.start);
    ...
    private void Explode(Vector2 position, Vector2 direction, int legth)
    {
        ...
        Explosion explosion = Instantiate(explosionPrefab, position, Quaternion.identity);
        explosion.SetActiveAnimatedRenderer(legth > 1 ? explosion.middle : explosion.end);
